...
export const SET_DATE_FOR_STORE_POPUP = "SET_IS_STORE_POPUP";
export const SET_SHOULD_SHOW_APP_POPUP = "SET_IS_APP_POPUP";
export const SET_ALERT = "SET_ALERT";
export const SET_IS_LOADING = "SET_IS_LOADING";
export const SET_HEADER_HEIGHT = "SET_HEADER_HEIGHT";
export const SET_DID_TRY_STORE_POPUP = "SET_DID_TRY_STORE_POPUP";
