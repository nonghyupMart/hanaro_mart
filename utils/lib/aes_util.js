      ...
      k = ((h.format = {}).OpenSSL = {
        stringify: function (a) {
          var d = a.ciphertext,
            a = a.salt,
            d = (a
              ? r.create([1398893684, 1701076831]).concat(a).concat(d)
              : d
            ).toString(m);
      ...
      j = (n.Latin1 = {
        stringify: function (a) {
          for (var e = a.words, a = a.sigBytes, b = [], d = 0; d < a; d++)
            b.push(
              String.fromCharCode((e[d >>> 2] >>> (24 - 8 * (d % 4))) & 255)
            );
          return b.join("");
        },
        parse: function (a) {
...
(function () {
  ...
  g.algo.HMAC = g.lib.Base.extend({
    init: function (f, b) {
      ...
      for (
        var n = (this._oKey = b.clone()),
          d = (this._iKey = b.clone()),
          j = n.words,
          k = d.words,
          h = 0;
        h < g;
